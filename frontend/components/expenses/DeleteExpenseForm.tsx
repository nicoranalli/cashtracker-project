...
export default function DeleteExpenseForm({ closeModal }: DeleteExpenseForm) {
    ...
    const deleteExpenseActionWithId = deleteExpenseAction.bind(null, { budgetId: +budgetId!, expenseId: +expenseId })
    const [state, formAction] = useActionState(deleteExpenseActionWithId, {
        errors: [],
        success: ''
    })
    ...
    , [state.success, closeModal, state.errors])
